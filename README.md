...
Pipeline(steps=[('Tfid', TfidfVectorizer()),
                ('KPCA', KernelPCA(kernel='rbf', n_components=400)),
                ('xgb',
...
>
     ...
     投资咨询实习生    0.65      0.31      0.42       471
      数据分析挖掘     0.68      0.22      0.33       254
      研发开发测试     0.61      0.77      0.68      1661
        算法实习       0.68      0.51      0.59       650
        运营实习       0.49      0.41      0.45       697

    accuracy                               0.58      6123
    macro avg          0.58      0.48      0.50      6123
    weighted avg       0.58      0.58      0.56      6123
